...
import net.seensin.springdockerswarmmanagementapi.common.exception.customExceptions.security.*;
...
import net.seensin.springdockerswarmmanagementapi.common.security.model.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public User update(User user) throws Exception {
        ...
        if (user.getId() != null) {
            ...
            user.setUserTempRolesSet(u.getUserTempRolesSet());
